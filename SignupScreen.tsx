...
interface SignupScreenProps {
  onSignupAttempt: (name: string, email: string, passwordPlain: string) => Promise<boolean>; // Changed from onSignupSuccess
...
const SignupScreen: React.FC<SignupScreenProps> = ({ onSignupAttempt, onNavigateToLogin, errorMessage }) => {
  ...
  const handleSignup = async () => {
    ...
    // onSignupAttempt (from App.tsx) will now handle Firebase auth, Firestore profile creation, and error setting
    await onSignupAttempt(trimmedName, trimmedEmail, trimmedPassword);
    // App.tsx will handle navigation and success messaging on successful attempt
    setIsLoading(false);
  };
